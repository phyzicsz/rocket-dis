...
public class DisAttribute {
    ...
    private Optional<AbstractAttribute> attributeType = Optional.empty();
...
//    }
//    
    public Optional<AbstractAttribute> getAttributeType() {
        return attributeType;
    }

    public void setAttributeType(AbstractAttribute type) {
        this.attributeType = Optional.ofNullable(type);
    }
