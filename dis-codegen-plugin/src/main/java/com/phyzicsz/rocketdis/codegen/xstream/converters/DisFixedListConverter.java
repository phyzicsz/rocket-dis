 ...
 * @author phyzicsz
 */
public class DisFixedListConverter implements Converter {

    private static final Logger LOGGER = LoggerFactory.getLogger(DisFixedListConverter.class);
    ...
    public Object unmarshal(HierarchicalStreamReader reader, UnmarshallingContext context) {
        DisFixedList attr = new DisFixedList();
    ...
    public boolean canConvert(Class type) {
        boolean assignable = DisFixedList.class.isAssignableFrom(type);
        return assignable;
    }
}
