 ...
 * @author phyzicsz
 */
public class DisVariableListConverter implements Converter {

    private static final Logger LOGGER = LoggerFactory.getLogger(DisVariableListConverter.class);
    ...
    public Object unmarshal(HierarchicalStreamReader reader, UnmarshallingContext context) {
        DisVariableList attr = new DisVariableList();
        ...
        for (Iterator<String> iter = reader.getAttributeNames(); iter.hasNext();) {
            ...
            switch (name) {
                case "countFieldName":
                    attr.setCountFieldName(reader.getAttribute("countFieldName"));
                    break;
    ...
    public boolean canConvert(Class type) {
        boolean assignable = DisVariableList.class.isAssignableFrom(type);
        return assignable;
    }
}
